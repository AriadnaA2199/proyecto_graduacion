...
>
    <div
        class="flex justify-between px-3 py-2 bg-white shadow-sm rounded-xl ring-1 ring-gray-950/5"
    >
        <div class="flex items-center gap-2">
            ...
            <div class="text-sm font-medium leading-6 text-gray-950 whitespace-nowrap">
                {{ $item->title }}
            </div>

            <div class="hidden overflow-hidden text-sm text-gray-500 sm:block whitespace-nowrap text-ellipsis">
                {{ $item->url }}
            </div>
        </div>
        <div class="flex items-center gap-2">
